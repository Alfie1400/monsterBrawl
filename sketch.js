...
function setup() {
 ...
 // dizzy.addImage(stunnedImg)
  ...
  enemy4=createSprite(width+13200,random(height/2-12222220,height/2+300))
...
function draw() {
 ...
 // console.log(gameState)
  ...
  textSize(20)
  fill("gold")
    text("score :"+score,width/2-575,height/2-240)
